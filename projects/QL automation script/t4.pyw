...
def get_input():
	...
	file_name1 = simid + '+' + associatename + '+' + DATE_INP4 + '+' + sellername + '+' + offertype + '+' +'QL template' + '.xlsx'
	file_name2 = simid + '+' + associatename + '+' + DATE_INP4 + '+' + sellername + '+' + offertype + '+' + 'Revoke template' + '.xlsx'
	file_name3 = simid + '+' + associatename + '+' + DATE_INP4 + '+' + sellername + '+' + offertype + '+' +'Time template' + '.xlsx'
	global root
	...
	worksheet.write('C2', date_fmt1,date_format)
	worksheet.write('D2', date_fmt2,date_format)
	...
	worksheet.write('A2', asin)
	worksheet.write('B2', sellerid)
	worksheet.write('C2', date_fmt3,date_format)
	...
	formatted_date_time2 = endtime1.strftime("%m/%d/%Y %H:%M:%S")
	utc = timezone('UTC')
	...
	worksheet.write('C2',user_datetime_utc.strftime("%m/%d/%Y %H:%M:%S"))
	worksheet.write('D2',user_datetime_utc2.strftime("%m/%d/%Y %H:%M:%S"))
